...
class SampleApplication : Application() {
    ...
    override fun onCreate() {
        ...
        val initDapp = WalletConnect.Params.Init(
            ...
            projectId = "4af2e046c7a7cbff0a96dc0f594b7e13",     //TODO: register at https://walletconnect.com/register to get a project ID
            isController = false,
        ...
        val initWallet = WalletConnect.Params.Init(
            application = this,
            relayServerUrl = "wss://$WALLET_CONNECT_URL?projectId=4af2e046c7a7cbff0a96dc0f594b7e13",   //TODO: register at https://walletconnect.com/register to get a project ID
            isController = true,
            metadata = WalletConnect.Model.AppMetaData(
                name = "Flutter Wallet",
